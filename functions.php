 ...
 */
	...
	function keel_register_menus() {
		register_nav_menus(
			array(
				'primary-logged-in' => __( 'Primary Menu - Logged In' ),
				'primary-logged-out' => __( 'Primary Menu - Logged Out' ),
				'secondary-logged-in' => __( 'Secondary Menu - Logged In' ),
				'secondary-logged-out' => __( 'Secondary Menu - Logged Out' ),
			)
		);
	}
